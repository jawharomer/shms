...
appEditCustomerOrder = angular.module("editCustomerOrder", []);

appEditCustomerOrder.factory('httpRequestInterceptor', function() {
	return {
...
appEditCustomerOrder.config(function($httpProvider) {
	$httpProvider.interceptors.push('httpRequestInterceptor');
});

appEditCustomerOrder
		.controller(
				'editCustomerOrder',
